  ...
  Users: {
    Auth: {
      ...
      CheckAddress: Joi.object({
        publicAddress: Joi.string().min(42).max(42).required(),
      }),
      ...
      Info: Joi.object({
        ...
        cryptoAccount: Joi.string().min(42).max(42).optional(),
        publicAddress: Joi.string().min(42).max(42).optional(),
  ...
  Brackets: {
    Bets: {
      ...
      Update: Joi.object({
        ...
        userId: Joi.string().min(24).max(24).optional(),
        currency: Joi.string().min(24).max(24).optional(),
        matchId: Joi.string().min(24).max(24).optional(),
        stake: Joi.number().optional(),
  ...
  Payments: {
    Payments: {
      ApproveWithdrawal: Joi.object({
        ...
        status: Joi.string()
          .valid("approve", "confirmed", "pending", "canceled")
          .required(),
      }),
      Create: Joi.object({
